...
final filteredNotesProvider = Provider<List<Map<String, dynamic>>>((ref) {
...
final selectedViewProvider = Provider<String>((ref) {
  return ref.watch(notesProvider).selectedView;
});

final selectedCategoryProvider = Provider<String>((ref) {
  return ref.watch(notesProvider).selectedCategory;
});
...
final sortByProvider = Provider<String>((ref) {
  return ref.watch(notesProvider).sortBy;
});
